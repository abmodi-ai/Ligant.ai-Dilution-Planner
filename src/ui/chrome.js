  ...
  return `
    <div class="footer-grid">
      <div class="footer-prose">
        ...
        <p>There is no account and no tracking of you. No login, no sign up, and no cookies. One script from outside this page runs on it, and it is named in the next paragraph; no other third-party code of any kind runs here.</p>
