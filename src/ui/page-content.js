...
<p>Entirely client-side: no user-entered data leaves the browser. The page loads one script from outside its own address — Cloudflare Web Analytics, which counts visits and page-load speed and reads nothing you enter. No account. Nothing persists across a reload.</p>
