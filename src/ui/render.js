...
function renderVessel(v, r, flags) {
  ...
  if (v.kind === 'stock') {
    ...
    grid = `<div class="vessel-grid">
      ...
      <div class="vg"><span class="k">Bound on departure</span><span class="v">±${esc(c.bound.display)}</span><span class="sub">relative, compounded along the chain; register: derived</span></div>`}
    </div>`;
  }
